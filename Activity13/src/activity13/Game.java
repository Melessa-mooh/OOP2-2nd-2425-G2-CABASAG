...
public class Game extends javax.swing.JFrame {
    ...
    private static final String IMAGE_PATH_PREFIX = "C:\\Users\\USER\\OneDrive\\Documents\\NetBeansProjects\\LAB-OOP2-JAVA\\Activity13\\src\\images\\";
    private static final String GAME_RECORD_FILE = "game_records.txt";
    ...
    public Game() {
        ...
        // Add menu bar for game history
        JMenuBar menuBar = new JMenuBar();
        JMenu gameMenu = new JMenu("Game");
        JMenuItem historyMenuItem = new JMenuItem("View History");
        
        historyMenuItem.addActionListener((java.awt.event.ActionEvent evt) -> {
            showGameHistory();
        });
        
        gameMenu.add(historyMenuItem);
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        Player computer = gameManager.getComputer();
        player.setChoice(0);
        computer.setChoice(0);
        
        ImageIcon pic = new ImageIcon(IMAGE_PATH_PREFIX + "questionMark.gif");
        ...
        ImageIcon compPic = new ImageIcon(IMAGE_PATH_PREFIX + "questionMark.gif");
        ...
        rc = 1;
        prgPlayerLife.setValue(player.getHp());
        prgComputerLife.setValue(computer.getHp());
        lblPlayerWins.setText("0");
        lblCompWins.setText("0");
        lblRound.setText("1");
    ...
    private void setVersus(){
        ImageIcon pic = new ImageIcon(IMAGE_PATH_PREFIX + "versus.png");
    ...
    private void roundCounter(){
        ...
        if(player.getHp() <= 0 || computer.getHp() <= 0){
            ...
            if(player.getHp() > computer.getHp()){
                ...
                lblPlayerWins.setText(String.valueOf(player.getWins()));
                player.incrementConsecutiveWins();
                computer.resetConsecutiveWins();
            }else{
                computer.incrementWins();
                lblCompWins.setText(String.valueOf(computer.getWins()));
                computer.incrementConsecutiveWins();
                player.resetConsecutiveWins();
            }
            
            // Check if we have a winner (2 consecutive wins)
            if (player.getConsecutiveWins() >= 2) {
                gameManager.setGameOver(true);
                JOptionPane.showMessageDialog(null, "Congratulations! You won the game with 2 consecutive wins!", 
                        "Game Over", JOptionPane.INFORMATION_MESSAGE);
                saveGameResult("Player");
            } else if (computer.getConsecutiveWins() >= 2) {
                gameManager.setGameOver(true);
                JOptionPane.showMessageDialog(null, "Computer won the game with 2 consecutive wins!", 
            ...
            // Disable Fight button if game is over
    ...
    /**
     * Saves the game result to a text file
     * @param winner The winner of the game ("Player" or "Computer")
     */
    private void saveGameResult(String winner) {
        try {
            File file = new File(GAME_RECORD_FILE);
            ...
            if (!fileExists) {
                bw.write("Date,Time,Winner,PlayerScore,ComputerScore,Rounds\n");
            }
            ...
            bw.write(dateFormat.format(now) + "," + 
                     ...
                     winner + "," + 
                     gameManager.getPlayer().getWins() + "," + 
                     gameManager.getComputer().getWins() + "," + 
                     rc + "\n");
            
            bw.close();
            fw.close();
            
            JOptionPane.showMessageDialog(null, "Game record saved successfully!", 
                    "Record Saved", JOptionPane.INFORMATION_MESSAGE);
            
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Error saving game record: " + e.getMessage(), 
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    
    /**
     * Shows the game history from the records file
     */
    private void showGameHistory() {
        try {
            ...
            if (!file.exists()) {
                JOptionPane.showMessageDialog(null, "No game records found.", 
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (parts.length >= 6) {
                    sb.append("Date: ").append(parts[0])
                      .append(", Time: ").append(parts[1])
                      .append(", Winner: ").append(parts[2])
                      .append(", Score: ").append(parts[3]).append("-").append(parts[4])
                      .append(", Rounds: ").append(parts[5])
                      .append("\n");
                }
            }
            ...
            JOptionPane.showMessageDialog(null, "Error reading game records: " + e.getMessage(), 
                    "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        setVersus();
        prgComputerLife.setValue(gameManager.getComputer().getHp());
        prgPlayerLife.setValue(gameManager.getPlayer().getHp());
        btnFight.setEnabled(false);
    }//GEN-LAST:event_formWindowOpened

    private void btnRock2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRock2ActionPerformed
        btnFight.setEnabled(true);
        gameManager.getPlayer().setChoice(1);
        
        ImageIcon pic = new ImageIcon(IMAGE_PATH_PREFIX + "rock.jpg");
        Image img = pic.getImage().getScaledInstance(lblPlayerPick.getWidth(), lblPlayerPick.getHeight(), Image.SCALE_DEFAULT);
        lblPlayerPick.setIcon(new ImageIcon(img));
    ...
    private void btnPaperActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPaperActionPerformed
        btnFight.setEnabled(true);
        gameManager.getPlayer().setChoice(2);
        
        ImageIcon pic = new ImageIcon(IMAGE_PATH_PREFIX + "paper.gif");
        Image img = pic.getImage().getScaledInstance(lblPlayerPick.getWidth(), lblPlayerPick.getHeight(), Image.SCALE_DEFAULT);
        lblPlayerPick.setIcon(new ImageIcon(img));
    ...
    private void btnScissorsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnScissorsActionPerformed
        btnFight.setEnabled(true);
        gameManager.getPlayer().setChoice(3);
        
        ImageIcon pic = new ImageIcon(IMAGE_PATH_PREFIX + "scissors.gif");
        Image img = pic.getImage().getScaledInstance(lblPlayerPick.getWidth(), lblPlayerPick.getHeight(), Image.SCALE_DEFAULT);
        lblPlayerPick.setIcon(new ImageIcon(img));
    ...
    private void btnFightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFightActionPerformed
        if (gameManager.isGameOver()) {
            JOptionPane.showMessageDialog(null, "Game is over. Please reset to play again.", 
                    "Game Over", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        computer.setChoice(rnd.nextInt(3) + 1);
        
        int playerChoice = player.getChoice();
        int compChoice = computer.getChoice();
        
        if(compChoice == 1){
            ImageIcon compPic = new ImageIcon(IMAGE_PATH_PREFIX + "rock.jpg");
            Image compImg = compPic.getImage().getScaledInstance(lblCompPick.getWidth(), lblCompPick.getHeight(), Image.SCALE_DEFAULT);
            lblCompPick.setIcon(new ImageIcon(compImg));
        } else if ( compChoice == 2){
            ImageIcon compPic = new ImageIcon(IMAGE_PATH_PREFIX + "paper.gif");
            Image compImg = compPic.getImage().getScaledInstance(lblCompPick.getWidth(), lblCompPick.getHeight(), Image.SCALE_DEFAULT);
            lblCompPick.setIcon(new ImageIcon(compImg));
        }else if(compChoice == 3){
            ImageIcon compPic = new ImageIcon(IMAGE_PATH_PREFIX + "scissors.gif");
            Image compImg = compPic.getImage().getScaledInstance(lblCompPick.getWidth(), lblCompPick.getHeight(), Image.SCALE_DEFAULT);
            lblCompPick.setIcon(new ImageIcon(compImg));
        }
